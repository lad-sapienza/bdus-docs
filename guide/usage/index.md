...
This section covers day-to-day use of the application.

## Navigation

The sidebar on the left provides access to all modules. It is organised into
three groups:
...
![Full application layout with sidebar open, showing navigation groups and active table selector](/images/v5/usage/layout-overview.png)
